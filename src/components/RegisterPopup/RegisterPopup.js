        ...
        <PopupWithForm name="register"
                       ...
                       children={
                           <>
                               ...
                               <input type="text" name="name" className="modal__input"
                                      placeholder="Введите своё имя" required autoComplete="off" value={name} minLength={2} onChange={handleNameChange}/>
                               <span className={`modal__error ${!nameIsValid ? 'modal__error_visible' : '' }`} id="urlAvatar-error">{nameErrorMessage}</span>
                           </>
                       }
        />
    );
