      ...
      <div className="footer__container">
        <ul className="footer__text-container">
          <li className="footer__link-main">
            <a className="footer__link-item" href={props.routePathStart}>
              Главная
            </a>
          </li>
          <li className="footer__link-yandex">
            <a className="footer__link-item" href="https://praktikum.yandex.ru/" target="_blank" rel="noreferrer">
              Яндекс.Практикум
            </a>
          </li>
        </ul>

        <ul className="footer__image-container">
